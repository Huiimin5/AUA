...
python test_pancreas_ged_supcontrast_all.py --gpu 0 --model=exp_pancreas_aua_stage1 --pth_name ${saved_model_name_stage1} > ../logs/exp_pancreas_aua_stage1_test_all.txt 2>&1
# protytype initialization
...
python test_pancreas_ged_supcontrast_all.py --gpu 0 --model=exp_pancreas_aua_stage2 --pth_name ${saved_model_name_stage2}> ../logs/exp_pancreas_aua_stage2_test_all.txt 2>&1
