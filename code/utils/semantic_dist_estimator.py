...
class semantic_dist_estimator():
    def __init__(self, feature_num, num_classes, semantic_dist_dir="",feat_dist_save_name='feat_dist', out_dist_save_name='out_dist' ):
        ...
        self.init(feature_num=feature_num, resume=semantic_dist_dir, feat_dist_save_name=feat_dist_save_name, out_dist_save_name=out_dist_save_name)

    def init(self, feature_num, resume="", feat_dist_save_name='feat_dist', out_dist_save_name='out_dist' ):
        if resume:
            if feature_num == self.class_num:
                resume = os.path.join(resume, out_dist_save_name+'.pth')
            elif feature_num == self.feature_num:
                resume = os.path.join(resume, feat_dist_save_name+'.pth')
            else:
